                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.php" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">3rd Hand</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Your Struggle Ends here</h4>
                        <p class="mb-4">Make social media useful!</p>

                        <form id="formAuthentication" class="mb-3" action="register.php" method="POST">
                            <div class="mb-3">
                                <label for="username" class="form-label">Name</label>
                                <input type="text" class="form-control" name="reg_fname" placeholder="First Name" autofocus value="<?php 
					                if(isset($_SESSION['reg_fname'])) {
						            echo $_SESSION['reg_fname'];
					                } 
					                ?>" required/> <br>
                                <input type="text" class="form-control" name="reg_lname" placeholder="Last Name" value="<?php 
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" name="reg_email" placeholder="Enter your email" value="<?php 
                            ...
                            <input type="email" class="form-control" name="reg_email2" placeholder="Confirm Email" value="<?php 
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    <input type="password" name="reg_password" id="password" class="form-control" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" required>
                                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                </div>
                                <div class="input-group input-group-merge">
                                    <input type="password" name="reg_password2" id="c_password" class="form-control" placeholder="Confirm Password"  aria-describedby="c_password" required>
                                </div>
                            </div>
                            ...
                            <input class="btn btn-primary d-grid w-100" type="submit" name="register_button" value="Register">
